...
contract LIFECrowdsaleInterface {
    ...
    */
    ...
    function initialize(uint256 hoursUntilStart, uint256 hoursUntilEnd, uint256 _rate, address _wallet, uint256 _cap, address _token, address _storageAddress, string memory badge) public;
    ...
    function computeAllowedInvestment(uint256 investment) public view returns (uint256);

    //Used by investors to buy tokens
    function buyTokens() public payable;

    //How much bonus does one investor get for the ether sent
    function getBonusRate(uint256 weiAmount) public view returns (uint256);
