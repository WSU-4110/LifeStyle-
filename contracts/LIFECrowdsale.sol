...
import "contracts/interfaces/LifeCrowdsaleInterface.sol";
import "contracts/storage/CrowdsaleStorage.sol";
import "contracts/libraries/SafeMath.sol";

contract LIFECrowdsale is LIFECrowdsaleInterface {
    ...
    function LIFECrowdsale(address _owned) {
        paused = false;
        owned = Owned(_owned);
    }
